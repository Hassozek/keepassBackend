...
class __TwigTemplate_181c01e1ea3a6f20e0d730852c4172be extends Template
{
                    ...
                    if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 187, $this->source); })()), "parameters", [], "any", false, false, false, 187)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        ...
                        foreach ($context['_seq'] as $context["key"] => $context["parameter"]) {
                            ...
                            if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["parameter"], "extraProperties", [], "any", false, true, false, 195), "_api_values", [], "array", true, true, false, 195)) {
                                // line 196
                                yield "                                                            ";
                                yield Twig\Extension\DebugExtension::dump($this->env, $context, ...[CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["parameter"], "extraProperties", [], "any", false, false, false, 196), "_api_values", [], "array", false, false, false, 196)]);
                                yield "
                                                        ";
                            } else {
                                // line 198
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@ApiPlatform/DataCollector/request.html.twig", "/mnt/c/Users/oskar/Documents/git/zadankoDlaArtura/password-manager-server/vendor/api-platform/core/src/Symfony/Bundle/Resources/views/DataCollector/request.html.twig");
    }
}
